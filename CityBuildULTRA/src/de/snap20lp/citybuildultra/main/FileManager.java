...
public class FileManager {
    ...
    public void initConfigDeath() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("death.broadcast.message", "%PREFIX%§a%PLAYER%§7 ist gestorben!");
            cfg.addDefault("death.sound.enabled", true);
            cfg.addDefault("death.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("death.sound.pitch", 1);
            cfg.addDefault("death.autorespawn.enabled", true);
            cfg.addDefault("death.autorespawn.delayseconds", 1);
            cfg.addDefault("death.respawnatspawn.enabled", true);
    ...
    public void initConfigSpawn() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.spawn.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.spawn.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.spawn.teleport.delay.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.spawn.teleport.delay.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.spawn.teleport.delay.abort.sound.sound", "BLOCK_ANVIL_LAND");
        }
    ...
    public void initConfigJoin() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("join.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigMoney() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.money.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.money.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.moneyother.notonline.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.moneyother.self.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.moneyadmin.syntax.give.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.moneyadmin.give.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.moneyadmin.syntax.remove.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.moneyadmin.remove.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.moneyadmin.syntax.reset.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.moneyadmin.reset.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigGamemode() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.gamemode.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.gamemode.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.gamemodeother.notonline.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.gamemodeother.target.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.gamemodeother.self.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigHeal() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.heal.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.heal.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.healother.notonline.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.healother.target.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.healother.self.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigFly() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.fly.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.fly.sound.flyon.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.fly.sound.flyoff.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.flyother.target.flyon.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.flyother.target.flyoff.sound.sound", "ENTITY_EXPERIENCE_ORB_PICKUP");
            cfg.addDefault("messages.commands.flyother.self.flyon.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.flyother.self.flyoff.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.flyother.notonline.sound.sound", "BLOCK_ANVIL_LAND");
        }
    ...
    public void initConfigDay() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.day.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.day.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigNight() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.night.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.night.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
    ...
    public void initConfigPay() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.pay.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.pay.cannotpayself.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.pay.notonline.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.pay.target.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.pay.self.nomoney.sound.sound", "BLOCK_ANVIL_BREAK");
            cfg.addDefault("messages.commands.pay.self.sound.sound", "ENTITY_PLAYER_LEVELUP");
            cfg.addDefault("messages.commands.pay.payment.target.sound.sound", "BLOCK_ANVIL_BREAK");
        }
    ...
    public void initConfigFire() {
        ...
        if(serverVersion.contains("1.8")) {
            ...
            cfg.addDefault("messages.commands.fire.syntax.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.fire.cannotburnself.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.fireother.notonline.sound.sound", "BLOCK_ANVIL_LAND");
            cfg.addDefault("messages.commands.fireother.target.sound.sound", "BLOCK_ANVIL_BREAK");
            cfg.addDefault("messages.commands.fireother.self.sound.sound", "ENTITY_PLAYER_LEVELUP");
        }
